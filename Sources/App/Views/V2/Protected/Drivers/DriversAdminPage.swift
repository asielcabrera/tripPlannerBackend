...
enum DriversAdminPage {
    struct IndexView: View {
        
        let viewModel: DriverAdminPageModel.IndexView
        
        var body: Content {
            DashboardAdminPage.BaseDashboardAdminPage("Workers") {
                Div {
                    Div {
                        Label {
                            "Search"
                    ...
                    ListDriverView(pagination: viewModel.pagination)
                }
                        ...
                        Div {
                            Div {
                                ...
                                Div {
                                    ...
                                    for role in UserModel.Roles.allCases {
                                        if role.rawValue == viewModel.user.role {
                                            Option {
                                                "\(role.description)"
                                            }
